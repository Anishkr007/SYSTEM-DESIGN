...
export default function Footer() {
  return (
    <footer className="mt-20 py-8 border-t border-white/10 glass bg-white/5 backdrop-blur-xl relative z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col items-center md:items-start gap-1">
            ...
            <p className="text-sm text-zinc-400">Built by Anish — Learning System Design Visually</p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-2">
            ...
            <p className="text-xs text-zinc-500">Open source. Learning in public.</p>
          </div>
        </div>
      </div>
    </footer>
